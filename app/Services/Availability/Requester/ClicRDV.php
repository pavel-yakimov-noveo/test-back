...
class ClicRDV implements RequesterInterface
{
    private const URL = "https://tech-test.joovence.dev/api/clic-rdv/availabilities?proId=%s";
    ...
    {
        return $doctorAgenda === Doctor::AGENDA_CLICRDV;
    }
